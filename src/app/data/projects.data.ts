...
export const projects: Projects[] = [
    {
        id: 1,
        tittle: 'Web Full Stack Restaurante',
        category: 'Back End y Front End',
        description: 'Desarrollo de una aplicación web desplegada en AWS para un restaurante de hamburguesas utilizando Angular y Spring Boot. La web incluye funciones importantes como pedidos a domicilio simulando un sistema de compra con carrito, gestión de usuarios con roles, sistema de reservas y seguimiento en tiempo real de los pedidos.',
        imgPortada: "../../assets/img/564shots_so.png",
        urlProyect: "https://github.com/SergioCabreraDev/Web-Sistema-de-Gestion-de-Restaurante-Full-Stack",
        technologies: [
            {
            name: "Spring Boot",
        ...
        {
            name: "Angular",
            urlImg: "../../assets/img/brand-angular.png"
        },
        {
            name: "SQL",
